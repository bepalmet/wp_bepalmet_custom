...
export default function GeneralSettings( 
    ...
    const ToggleAll = ( { 
        ...
        const allLabel = state ? __( "Deselect all", "wp-bepalmet-custom" ) : __( "Select all", "wp-bepalmet-custom" );
    ...
    return (
        ...
        >
            <Panel>
                <PanelBody
                    title={ __( "Shown locations in order", "wp-bepalmet-custom" ) }
                    initialOpen={ locsTrue.length > 0 }
                >
                    <div 
                        className={ clsx( props.className, "drag-hint" ) }
                        title={ __( "Drag by holding click on an element and moving the mouse", "wp-bepalmet-custom" ) }
                    >
                        { __( "You can change the order of the shown locations by draging them", "wp-bepalmet-custom" ) }
                    </div>
            ...
            <Panel>
                <PanelBody
                    title={ __( "Hidden locations", "wp-bepalmet-custom" ) }
